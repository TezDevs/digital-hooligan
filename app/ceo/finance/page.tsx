...
export default function CeoFinancePage() {
    // Placeholder numbers – swap later when you have real Stripe / bank data.
    const estMRR = '$4,250';
                ...
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-muted-foreground">
                            Simple view of money in, money out, and how your apps are
                        ...
                        <ul className="mt-4 space-y-2 text-xs">
                            {cashMovements.map((m) => (
                                ...
                                >
                                    ...
                                    <span
                                        className={`text-[11px] font-semibold ${m.type === 'In'
                                                ? 'text-emerald-400'
                                                : 'text-rose-400'
                                            }`}
                                    >
