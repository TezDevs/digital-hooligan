        ...
        <div className="mx-auto max-w-5xl space-y-6">
          <div className="space-y-4">
            ...
            <p className="max-w-3xl text-sm text-slate-300 sm:text-base">
              ...
              as a veteran-owned small business that focuses on small, focused
              builds supporting mission teams with modern, maintainable
              software.
            </p>
          </div>

          {/* Credentials (Must-add credibility) */}
          <div className="rounded-2xl border border-slate-800 bg-black/60 p-5">
            ...
            <div className="mt-3 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="rounded-2xl border border-slate-800 bg-slate-950/60 p-4">
                ...
                <p className="mt-1 text-sm font-semibold text-slate-50">VOSB</p>
                <p className="text-xs text-slate-400">
            ...
            <p className="mt-3 text-xs text-slate-400">
              UEI / CAGE and additional registration details available upon
              request.
            </p>
          </div>
        </div>
        ...
        <div className="mx-auto grid max-w-5xl gap-8 md:grid-cols-[minmax(0,1.3fr),minmax(0,1fr)]">
          <div className="space-y-3 text-sm text-slate-300">
            ...
            <ul className="space-y-2">
              <li>
                • Unclassified or low-side work with remote-friendly teams
              </li>
              <li>• Small task orders that benefit from one strong builder</li>
              <li>
                • Programs that want to experiment before scaling a full team
              </li>
              <li>
                • Offices that need internal tools but can&apos;t wait 18 months
              </li>
            </ul>
          </div>
        ...
        <div className="mx-auto max-w-5xl space-y-6 text-sm text-slate-300">
          ...
          <ol className="space-y-3 text-xs sm:text-sm">
            ...
            <li>
              ...
              – Ship early versions, collect feedback, and refine until
              it&apos;s useful day-to-day.
            </li>
            <li>
              <span className="font-semibold text-slate-100">
                4. Hand off or extend
              </span>{" "}
              – Continue iterating with Digital Hooligan, or hand off clean code
              and docs to a larger internal or vendor team.
            </li>
          </ol>
        </div>
      </section>
