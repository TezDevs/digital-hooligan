...
const inputClass =
  "mt-[6px] w-full rounded-none border border-neutral-500 bg-transparent px-[10px] py-[8px] text-[15px] leading-6 text-neutral-100 placeholder:text-neutral-500";
...
export default function RadixOSDecisionsIndexPage() {
  return (
    <main className={containerClass}>
      ...
      <p className={pClass}>
        Each entry represents a single, explicitly authored human Decision,
        stored as an immutable historical record.
      </p>
      ...
      <div className="mt-[6px] flex flex-col gap-y-[8px]">
        <input
          className={inputClass}
          type="text"
          aria-label="Created timestamp from"
          placeholder="From"
        />
        <input
          className={inputClass}
          type="text"
          aria-label="Created timestamp to"
          placeholder="To"
        />
      </div>
      ...
      <div
        ...
        role="radiogroup"
        aria-label="Review cycle present"
      >
        <label className="text-[15px] leading-6 text-neutral-100">
      ...
      <p className={pClass}>
        No Decisions are displayed on this surface without an attached public
        data source.
      </p>

      <p className={metaClass}>
        Absence of a Decision indicates absence of a recorded decision, not
        inaction or failure.
      </p>
    </main>
  );
