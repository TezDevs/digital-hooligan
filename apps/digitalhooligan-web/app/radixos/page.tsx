...
const metaClass = "mt-[8px] text-[13px] leading-5 text-neutral-400";
  ...
  return (
    <main className={containerClass}>
      ...
      <h1 className={titleClass}>
        RadixOS is a Decision &amp; Accountability OS.
      </h1>

      <p className={pClass}>
        It records explicit human judgment as immutable, first-class
        objects—binding who decided what, when, under which constraints, with
        which assumptions and confidence bounds, and with what declared review
        cadence.
      </p>
      <p className={pClass}>
        RadixOS sits above tools and execution, below judgment.
      </p>

      <h2 className={h2Class}>What RadixOS Does</h2>
      <p className={pClass}>
        RadixOS exists to record and preserve executive judgment.
      </p>
      <p className={pClass}>
        A Decision exists only when a human explicitly authors it. Each Decision
        is stored as an immutable record with:
      </p>
      <div className={listClass}>
        <div>A single Owner</div>
        <div>
          Declared constraints (including time, resources, and irreversibility)
        </div>
      ...
      <p className={pClass}>
        ...
        environments, or drive execution. Those capabilities collapse authority
        and create post-hoc rationalization risk.
      </p>

      <h2 className={h2Class}>Position in the System</h2>
      <p className={pClass}>
        RadixOS is a governance layer, not an execution layer.
      </p>
