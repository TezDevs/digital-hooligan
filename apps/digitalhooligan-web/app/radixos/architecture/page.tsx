...
export default function RadixOSArchitecturePage() {
  return (
    <main className={containerClass}>
      ...
      <p className={pClass}>
        It records Decisions without collapsing boundaries between: Context, Decision, Signal,
        Execution
      </p>

      <h2 className={h2Class}>System Boundaries</h2>
      <p className={pClass}>RadixOS consumes context; it does not generate or own it</p>
      <p className={pClass}>RadixOS records Decisions; it does not infer or recommend them</p>
      <p className={pClass}>RadixOS preserves history; it does not trigger actions</p>
      <p className={pClass}>
        It integrates with surrounding systems without becoming an execution hub.
      </p>
