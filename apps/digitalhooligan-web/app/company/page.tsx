                ...
                <div className="mx-auto max-w-5xl grid gap-6 md:grid-cols-3">
                    ...
                    <div className="space-y-2 rounded-2xl border border-slate-800 bg-black/80 p-4 text-xs text-slate-300">
                        ...
                        <ul className="space-y-1.5">
                            ...
                            <li>
                                <span className="font-medium text-slate-100">SBA:</span>{" "}
                ...
                <div className="mx-auto max-w-5xl grid gap-8 md:grid-cols-[minmax(0,1.2fr),minmax(0,1fr)]">
                    <div className="space-y-3 text-sm text-slate-300">
                        ...
                        <ul className="space-y-2 text-xs sm:text-sm">
                            <li>• Short discovery to clarify constraints, environment, and goals.</li>
                            <li>• Transparent milestones and simple updates—not endless decks.</li>
                            <li>• Preference for dashboards, observability, and clear outcomes.</li>
                            <li>• Comfortable collaborating with existing dev, test, or ops teams.</li>
                        </ul>
                    </div>
                ...
                <div className="mx-auto flex max-w-5xl flex-col gap-4 border-t border-slate-800 pt-6 sm:flex-row sm:items-center sm:justify-between">
                    <div className="space-y-1 text-sm text-slate-200">
                        ...
                        <p className="text-xs text-slate-400">
                            A short, direct email with your environment, constraints, and goals is
                            perfect—no giant RFP required to start the conversation.
                        </p>
                    </div>
